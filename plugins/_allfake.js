...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "120363206031661279@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Bayu","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
               
                   global.ftoko = {
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6283824505310@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "120363206031661279@g.us",
                   "inviteCode": "null",
                   "groupName": "Kawan Bayu", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
               }
           }
