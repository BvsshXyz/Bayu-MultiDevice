...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'ʙᴀʏᴜ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
      ...
      video: fs.readFileSync('./menuvid/elaina.mp4'),
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ᴍ ᴇ ɴ ᴜ  ʙ ᴏ ᴛ  ʙ ᴀ ʏ ᴜ',
                    thumbnailUrl: 'https://telegra.ph/file/002e7bf25b03f8e54fcc1.jpg',
                    sourceUrl: 'https://linktr.ee/bayuvpnstore',
                    mediaType: 1,
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ʙᴀʏᴜ xʏᴢ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VakNome9RZAZzbyIqt24', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
